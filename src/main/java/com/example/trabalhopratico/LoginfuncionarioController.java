...
public class LoginfuncionarioController{
    ...
    public static String pegarnomefuncionario;
    @FXML
    public void loginButtonOnAction(ActionEvent event){
        if (usernameTextField.getText().isBlank()==false && passwordPasswordField.getText().isBlank()==false){
            pegarnomefuncionario=getusernameTextField1();
            ValidateLogin();
        }else {
    ...
    public void ValidateLogin(){
        ...
        String verifyLogin="SELECT count(1) FROM funcionario WHERE username = '" + usernameTextField.getText() + "' AND password = '" + passwordPasswordField.getText() + "'";
        try {
    ...
    public void createAccountForm(){
        try{
            Parent root = FXMLLoader.load(getClass().getResource( "registerfuncionario.fxml"));
    ...
    public void createPageForm(){
        try{
            Parent root = FXMLLoader.load(getClass().getResource( "Homefuncionario.fxml"));
